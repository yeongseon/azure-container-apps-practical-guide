...
1.  [**Local Development**](./01-local-development.md) — Learn how to containerize and run your Spring Boot app in Docker on your local machine.
...
| Config and secrets | Complete | [03-configuration](./03-configuration.md) |
