...
Run `fix-and-capture.sh` (formerly named `verify.sh` before the 2026-06-25 Phase B overlay; the captured log file `00-verify-run.txt` keeps its name for schema stability across the rename), which:
