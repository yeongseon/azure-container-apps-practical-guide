...
1. [01 - Run Locally with Docker](../language-guides/python/tutorial/01-local-development.md)
2. [02 - First Deploy to Azure Container Apps](../language-guides/python/tutorial/02-first-deploy.md)
3. [03 - Configuration, Secrets, and Dapr](../language-guides/python/tutorial/03-configuration.md)
4. [04 - Logging, Monitoring, and Observability](../language-guides/python/tutorial/04-logging-monitoring.md)
5. [05 - Infrastructure as Code with Bicep](../language-guides/python/tutorial/05-infrastructure-as-code.md)
6. [06 - CI/CD with GitHub Actions](../language-guides/python/tutorial/06-ci-cd.md)
7. [07 - Revisions and Traffic Splitting](../language-guides/python/tutorial/07-revisions-traffic.md)
...
| SRE / Operator | Stabilize production and reduce incident MTTR | 04, operations/monitoring, troubleshooting index | [Reference: Metrics](../reference/metrics/index.md) (including KEDA scaler observability), alerts, recovery, KQL packs | 8-12 hours |
