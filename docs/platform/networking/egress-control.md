...
## Portal view: non-integrated baseline for the Bicep examples

This screenshot is used here as a visual contrast baseline for the Bicep examples in [User-Defined Routes (UDR)](#user-defined-routes-udr) and [NAT Gateway for Static Outbound IP](#nat-gateway-for-static-outbound-ip).
