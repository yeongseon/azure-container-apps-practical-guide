...
| `evidence/q6-baseline-vs-perturb-vs-supplemental-20260613055031.tsv` | Committed (PII-scrubbed) | Q6 phase-level comparison — historical, pre-scaffold, non-authoritative early-supplemental snapshot captured after restart event 1. Superseded by `...072623.tsv` (control-bucket scaffold applied per Oracle binding #7). |
