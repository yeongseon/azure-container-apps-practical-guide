...
- **Evidence levels**: Every query above ties to one of the lab's evidence categories (`[Observed]`, `[Measured]`, `[Correlated]`, `[Inferred]`, `[Not Proven]`). The single weakest claim — per-replica AZ placement — remains `[Not Proven]` because Container Apps management plane does not expose it.
